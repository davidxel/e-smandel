import { UNCLASSIFIED_CLASS_ID, UNCLASSIFIED_CLASS_NAME } from '../lib/classConstants'
...
export function buildInitialClasses(): ClassRoom[] {
  return [
    { id: UNCLASSIFIED_CLASS_ID, name: UNCLASSIFIED_CLASS_NAME },
...
export function buildInitialUsers(): User[] {
  return [
    ...
    },
    {
      ...
      taught_class_ids: ['cls-x-ipa-1', 'cls-x-ipa-2'],
      isKokurikulerCoordinator: false,
      profilePhotoDataUrl: null,
    },
    {
